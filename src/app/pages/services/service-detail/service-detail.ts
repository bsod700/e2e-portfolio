...
// Keep this data outside the component class so it is created once,
// not every time the component is instantiated.
const ALL_SERVICES: ReadonlyArray<ServiceOffering> = [
  {
    id: 'development',
    title: 'Development',
...
export class ServiceDetailComponent implements OnInit {
  ...
  // All services data (immutable, shared instance)
  private readonly allServices: ReadonlyArray<ServiceOffering> = ALL_SERVICES;
  ...
  goBack(): void {
    // Navigate to the home page and scroll to the services section
